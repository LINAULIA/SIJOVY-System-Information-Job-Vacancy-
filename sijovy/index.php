...
<head>
    ...
    <title>System Information Job Vacancy</title>
...
<body style="font-family:verdana">
    ...
    <div class="wraper">
        ...
        <!-- header end -->
        <!-- slider start -->
        <div style="background-image:url('2.jpg');background-repeat:no-repeat;  width:100%; height:500px;">
            <div class="container-fluid text-center">
                <div class="slider-text" style="margin-top:7%; margin-left:45%;">
                    <h2 style="color:white; font-family:verdana">SI JOVY</h2>
                    <h6 style="color:white; font-family:verdana">System Information Job Vacancies</h6>
        ...
        <div class="blog-area pb-70" style="margin-top:5%">
            <div class="container-fluid">
                <div class="section-title text-center mb-50">
                    <h4>SELAMAT DATANG PARA PEKERJA KERAS :)</h3>
                        <p></p>
                </div>
                        ...
                        <div class="col-md-3 col-sm-6">
                            <div class="single-blog mb-30">
                                ...
                                <div class="blog-title">
                                    ...
                                    <a href="apply.php" type="button" class="btn btn-primary">
