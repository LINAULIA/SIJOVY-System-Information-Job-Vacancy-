                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-sm-flex justify-content-between align-items-center">
									<h2>SUDAH LEWAT DEADLINE</h2>
									<button style="margin-bottom:20px" data-toggle="modal" data-target="#myModal" class="btn btn-warning col-md-2"><span class="glyphicon glyphicon-plus"></span>Tambah Job Baru</button>
                                </div>
