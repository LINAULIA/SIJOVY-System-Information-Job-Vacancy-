	...
	<div class="page-container">
		...
		<div class="sidebar-menu">
			<div class="sidebar-header">
				<h2> SI JOVY </h1>
					<h5> System Information Job Vacancy</h5>
					<style>
						h2 {
							text-align: center;
							color: white;
				...
				<div class="menu-inner">
					<nav>
						<ul class="metismenu" id="menu">
							<li>
								<a href="index.php"><i class="ti-dashboard"></i><span>DATA PEKERJAAN</span></a>
							</li>
							<li class="active">
								<a href="applicant.php"><i class="ti-dashboard"></i><span>DATA PELAMAR</span></a>
							</li>
							<li>
								<a href="scheduling.php"><i class="ti-dashboard"></i><span>WAWANCARA</span></a>
							</li>
							<li>
						...
						<div class="card">
							<div class="card-body">
								<div class="d-sm-flex justify-content-between align-items-center">
									<h2>Kelola Pelamar Pekerjaan (Belum Diproses)</h2>
								...
								<div class="data-tables datatable-dark">
									<table id="dataTable3" class="display" style="width:100%">
										...
										<tbody>
											<?php
											$job1 = mysqli_query($conn, "SELECT * FROM applicant JOIN applicant_job ON applicant.id=applicant_job.id and action='0' order by applicant_id ASC");
											$no = 1;
													...
													<div class="modal-dialog modal-lg">
														<div class="modal-content">
															...
															<div class="modal-footer">
																...
																<input type="submit" data-toggle="modal" data-target="#interview<?php echo $id; ?>" class="btn btn-warning" value="Jadwalkan Interview">
															</div>
														</div>
													</div>
												</div>
													...
													<div class="modal-dialog">
														<div class="modal-content">
															...
															<div class="modal-footer">
																...
																<input type="submit" name="schedule" class="btn btn-warning" value="Jadwalkan">
															</div>
															</form>
														</div>
													</div>
				...
				<div class="row mt-5 mb-5">
					<div class="col-12">
						<div class="card">
							<div class="card-body">
								<div class="d-sm-flex justify-content-between align-items-center">
									<h2>Kelola Pelamar Pekerjaan (Sudah Diproses)</h2>
